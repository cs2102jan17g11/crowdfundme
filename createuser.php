...
if(isset($_POST['submit'])) {
    ...
    if (!isset($error)) {
        ...
        createUser($email, $first_name, $last_name, $hashedpassword, $role);
...
<div class="container">
    ...
    if(isset($error)){ ?>
        <div class="alert alert-danger">
            <strong>Unable to create user due to the follow reason(s):</strong><br>
            <?php
    ...
    <form role="form" method="post" action="" autocomplete="off">
        ...
        <div class="row">
            <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Create" class="btn btn-primary btn-block btn-lg" tabindex="6"></div>
        </div>
    </form>
</div>
